extern const preparation_def preparation_list[] =
{
    {
        PREP_ATTACK,
        DUR_HERKAN_ATTACKING_WARMUP, DUR_HERKAN_ATTACKING,
        1, "Attack",
        ...
        {
            STATUS_HERKAN_ATTACKING,
            GREEN, "+Atk", "focusing on attacks",
            "You are keenly focused on attacks, but neglecting defence."
        },
    ...
    {
        PREP_REGEN,
        DUR_HERKAN_REGENERATING_WARMUP, DUR_HERKAN_REGENERATING,
        2, "Regeneration",
        ...
        {
            STATUS_HERKAN_REGENERATING,
            GREEN, "+Regen", "fueling regeneration",
            "You are metabolizing food repidly to provide fuel for healing.",
        },
